---
name: openspec-publish
description: Publish a change's docs to the team wiki (Confluence, Azure Wiki, ClickUp) and create the user story plus FE/BE/Tester subtasks with the doc link. Use when a spec is ready to hand to the team.
allowed-tools: Bash(openspec:*)
license: MIT
compatibility: Requires openspec CLI; wiki/tracker access via MCP, provider CLI, or REST.
metadata:
  author: openspec
  version: "1.0"
  generatedBy: "1.6.0"
