---
name: openspec-setup
description: Set up third-party MCP server connections (Jira, GitHub, GitLab, Postgres, MySQL, MongoDB, or a custom server) for your AI tool. Use when the user wants to connect external tools or data sources via MCP.
allowed-tools: Bash(openspec:*)
license: MIT
compatibility: Configures MCP servers in your AI tool; no openspec CLI needed at runtime.
metadata:
  author: openspec
  version: "1.0"
  generatedBy: "1.6.0"
